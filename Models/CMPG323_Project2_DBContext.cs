...
{
    public partial class CMPG323_Project2_DBContext : DbContext
    {
        public CMPG323_Project2_DBContext()
        {
        }

        public CMPG323_Project2_DBContext(DbContextOptions<CMPG323_Project2_DBContext> options)
            : base(options)
        {
        }
